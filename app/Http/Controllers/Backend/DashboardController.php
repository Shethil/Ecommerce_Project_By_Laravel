...
class DashboardController extends Controller
{
    public function dashboard()
    {
        ...
        return view('backend.layouts.pages.dashboard', compact('total_earning', 'total_order_count', 'total_categories', 'total_products', 'total_customers', 'orders', 'order_yearwise'));
    }
}
