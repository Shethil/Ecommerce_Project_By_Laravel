...
class TestimonialController extends Controller
{
    ...
    public function index()
    {
        $testimonials = Testimonial::latest('id')
            ->select(['id', 'client_name', 'client_name_slug', 'client_designation', 'client_message', 'client_image', 'updated_at'])->paginate(5);

        return view('backend.layouts.pages.testimonial.index', compact('testimonials'));
    }
    ...
    {
        return view('backend.layouts.pages.testimonial.create');
    }
