                            ...
                            <li class="col-xl-3 col-lg-4 col-sm-6 col-12">
                                <div class="product-wrap">
                                    ...
                                    <div class="product-content">
                                        <h3><a
                                                href="{{ route('productdetails.page', ['product_slug' => $product->slug]) }}">{{ $product->name }}</a>
                                        </h3>
                                        <p class="pull-left">
                            ...
                            @foreach ($category->products as $cproduct)
                                <li class="col-xl-3 col-lg-4 col-sm-6 col-12">
                                    <div class="product-wrap">
                                        <div class="product-img">
                                            <span>Sale</span>
                                            <img src="{{ asset('uploads/product') }}/{{ $cproduct->product_image }}"
                                                alt="">
                                            <div class="product-icon flex-style">
                                                <ul>
                                                    <li><a data-toggle="modal" data-target="#exampleModalCenter"
                                        ...
                                        <div class="product-content">
                                            <h3><a
                                                    href="{{ route('productdetails.page', ['product_slug' => $cproduct->slug]) }}">{{ $cproduct->name }}</a>
                                            </h3>
                                            <p class="pull-left">
