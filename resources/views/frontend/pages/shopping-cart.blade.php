                        ...
                        <tbody>
                            ...
                            @foreach ($carts as $cartitem)
                                <tr>
                                    ...
                                    <td class="remove">
                                        <a href="{{ route('removefrom.cart', ['cart_id' => $cartitem->rowId]) }}" <i
                                            class="fa fa-times"></i>
                                        </a>
                                    </td>
                                </tr>
                            ...
                            <div class="cart-total text-right">
                                ...
                                <ul>
                                    @if (Session::has('coupon'))
                                        ...
                                        <li><span class="pull-left"> Total </span> ${{ Session::get('coupon')['balance'] }}
                                            <del class="text-danger"> ${{ Session::get('coupon')['cart_total'] }}</del>
                                        </li>
                                    @else
